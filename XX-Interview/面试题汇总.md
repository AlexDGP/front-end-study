...
- 前端水印: css属性:pointer-events:none MutationOberserver https://www.bilibili.com/video/BV1xY41177nU/?spm_id_from=333.337.search-card.all.click&vd_source=6e9c2de5b89c2ba4e13469e295319397
...
- this的指向问题,箭头函数,call,apply,bind: https://www.bilibili.com/video/BV1NT4y1j7xH/?spm_id_from=333.337.search-card.all.click&vd_source=6e9c2de5b89c2ba4e13469e295319397
- 前端安全
  - XSS(cross site srcripting)跨站脚本攻击,注入脚本,url参数注入,输入框注入.对输入进行过滤
  - XSRF(cross site request forgery)跨站请求伪造,伪造请求
...
![image-20231026171947643](./assets/image-20231026171947643.png)
