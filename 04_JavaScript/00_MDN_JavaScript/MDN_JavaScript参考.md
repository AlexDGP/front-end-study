...
如果你对 JavaScript 不熟悉，请先阅读[指南](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Guide)。一旦你牢牢地掌握了基础知识，就可以使用参考资料，来获取有关各个对象和语言结构的更加详细的知识。

## [内置对象](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#内置对象)

[JavaScript 标准内置对象](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects)，以及它们的方法和属性。

### [值属性](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#值属性)

- [x] [`Infinity`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Infinity)
- [x] [`NaN`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/NaN)
- [x] [`undefined`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/undefined)
- [x] [`globalThis`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/globalThis)

### [Function 属性](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#function_属性)

- [x] [`eval()`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/eval)
- [x] [`isFinite()`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/isFinite)
- [x] [`isNaN()`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/isNaN)
- [x] [`parseFloat()`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/parseFloat)
- [x] [`parseInt()`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/parseInt)
- [x] [`decodeURI()`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/decodeURI)
- [x] [`decodeURIComponent()`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/decodeURIComponent)
- [x] [`encodeURI()`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/encodeURI)
- [x] [`encodeURIComponent()`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/encodeURIComponent)

### [基本对象](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#基本对象)
...
### [错误对象](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#错误对象)
...
### [数字和日期](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#数字和日期)

- [x] [`Number`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Number)
- [x] [`BigInt`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/BigInt)
...
### [文本处理](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#文本处理)

- [ ] [`String`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/String)
- [ ] [`RegExp`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/RegExp)

### [索引集合类](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#索引集合类)
...
### [Keyed collections](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#keyed_collections)
...
### [结构化数据](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#结构化数据)
...
### [控制抽象化](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#控制抽象化)
...
### [反射](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#反射)

- [ ] [`Reflect`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Reflect)
- [ ] [`Proxy`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Proxy)

### [国际化](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#国际化)
...
### [WebAssembly](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#webassembly)

- [ ] [`WebAssembly`](https://developer.mozilla.org/zh-CN/docs/WebAssembly/JavaScript_interface)
- [ ] [`WebAssembly.Module`](https://developer.mozilla.org/zh-CN/docs/WebAssembly/JavaScript_interface/Module)
- [ ] [`WebAssembly.Instance`](https://developer.mozilla.org/zh-CN/docs/WebAssembly/JavaScript_interface/Instance)
- [ ] [`WebAssembly.Memory`](https://developer.mozilla.org/zh-CN/docs/WebAssembly/JavaScript_interface/Memory)
- [ ] [`WebAssembly.Table`](https://developer.mozilla.org/zh-CN/docs/WebAssembly/JavaScript_interface/Table)
- [ ] [`WebAssembly.CompileError`](https://developer.mozilla.org/zh-CN/docs/WebAssembly/JavaScript_interface/CompileError)
- [ ] [`WebAssembly.LinkError` (en-US)](https://developer.mozilla.org/en-US/docs/WebAssembly/JavaScript_interface/LinkError)
- [ ] [`WebAssembly.RuntimeError`](https://developer.mozilla.org/zh-CN/docs/WebAssembly/JavaScript_interface/RuntimeError)

## [语句](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#语句)

[`语句和声明`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Statements)

### [控制流](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#控制流)
...
### [迭代](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#迭代)
...
### [其他](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#其他)
...
## [表达式和运算符](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#表达式和运算符)

[`表达式和运算符`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Operators).

### [Primary expressions](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#primary_expressions)
...
### [Left-hand-side expressions](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#left-hand-side_expressions)
...
### [Increment & decrement](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#increment_decrement)

- [ ] [`A++` (en-US)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators)
- [ ] [`A--` (en-US)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators)
- [ ] [`++A` (en-US)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators)
- [ ] [`--A` (en-US)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators)

### [一元运算符](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#一元运算符)
...
### [算术运算符](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#算术运算符)
...
### [关系运算符](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#关系运算符)
...
### [相等运算符](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#相等运算符)
...
### [位移运算符](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#位移运算符)

- [ ] [`<<` (en-US)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators)
- [ ] [`>>` (en-US)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators)
- [ ] [`>>>` (en-US)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators)

### [位运算](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#位运算)

- [ ] [`&` (en-US)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators)
- [ ] [`|` (en-US)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators)
- [ ] [`^` (en-US)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators)

### [逻辑运算](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#逻辑运算)

- [ ] [`&&` (en-US)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators)
- [ ] [`||` (en-US)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators)

### [条件运算符](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#条件运算符)

- [ ] [`(condition ? ifTrue : ifFalse)`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Operators/Conditional_Operator)

### [赋值操作符](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#赋值操作符)

- [ ] [`=` (en-US)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators#assignment_operators)
- [ ] [`*=` (en-US)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators#assignment_operators)
- [ ] [`/=` (en-US)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators#assignment_operators)
- [ ] [`%=` (en-US)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators#assignment_operators)
- [ ] [`+=` (en-US)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators#assignment_operators)
...
## [函数](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#函数)

本章介绍如何使用 [JavaScript 函数](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Functions) 来开发应用程序。
...
## [附加参考页面](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference#附加参考页面)
